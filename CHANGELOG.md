...
### Features
* add telemetry event on what filesystem is used (#843) ([`ddee082`](https://github.com/aws-deadline/deadline-cloud-worker-agent/commit/ddee0827a127c1b74599d934f653a2631558ebf8))
* add telemetry event on what filesystem is used ([`ddee082`](https://github.com/aws-deadline/deadline-cloud-worker-agent/commit/ddee0827a127c1b74599d934f653a2631558ebf8))

### Bug Fixes
* small files in syncInputJobAttachment causes sync cancel (#805) ([`3af802b`](https://github.com/aws-deadline/deadline-cloud-worker-agent/commit/3af802b0a2204864ee3093834e1916ff87100656))
