...
TEST_RECORDS = (
    ...
    pytest.param(
        ...
        "🔷 Session.Add 🔷 ",
        "[session-1234] A message (ActionIds: ['sessionaction-1234', 'sessionaction-abcd']) [queue-1234/job-1234]",
        id="Session Add",
    ),
    pytest.param(
        SessionLogEvent(
    ...
    pytest.param(
        ...
        "🟢 Action.Start 🟢 ",
        "[session-1234](sessionaction-1234) A message [queue-1234/job-1234]",
    ...
    pytest.param(
        ...
        "🟣 Action.End 🟣 ",
        "[session-1234](sessionaction-1234) A message (Status: SUCCESS) [queue-1234/job-1234]",
