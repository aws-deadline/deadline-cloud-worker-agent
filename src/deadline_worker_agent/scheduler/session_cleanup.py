...
class SessionUserCleanupManager:
    ...
    def _posix_cleanup_user_processes(user: SessionUser):
        ...
        try:
            ...
            # Linux pkill -e stdout will look like:
            #  <process name> killed (pid 1111)
            #  <process name2> killed (pid 2222)
            # macOS pkill -l stdout will look like (no option to print process name):
            #  kill -15 1111
            #  kill -15 2222
